  ...
  <div  class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>This is Social Platform Like Twitter is developed by <span style="font-weight: 700;"><a style="color:#207ce5;" href="https://github.com/TalhaShaikh24">Talha Shaikh</a></span>.</p>
        ...
        <div class="sidebar-left">
          ...
          <div class="box-user">
            <div class="grid-user">
              ...
              <div>
                <p class="name">
                  <a  href="<?php echo BASE_URL . $user->username; ?>"  style="margin-top: 4px">
                    <strong> <?php echo $user->name ?> </strong>
                  </a>
                </p>
                <p class="username">@<?php echo $user->username; ?></p>
              </div>
              <div class="mt-arrow d-none">
                <img
